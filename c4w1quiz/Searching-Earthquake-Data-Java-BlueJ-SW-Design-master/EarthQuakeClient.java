...
public class EarthQuakeClient
{
    ...
    public void bigQuakes() {
        //the magnitude of the 20th largest earthquakes
    ...
    public void quakesOfDepth(){
        ...
        ArrayList<QuakeEntry> list  = parser.read(source);
        System.out.println("read data for "+list.size()+" quakes");
        //between -4000.0 and -2000.0, exclusive
        ArrayList<QuakeEntry> quakeDepth = filterByDepth(list, -4000.0, -2000.0);
        //
        //nov20quakedata.atom (a file with information on 1518 quakes) 
        //for quakes with depth between -12,000.0 and -10,000.0, exclusive.
        //ArrayList<QuakeEntry> quakeDepth = filterByDepth(list, -12000.0, -10000.0);
    ...
    public void quakesByPhrase(){
        ...
        ArrayList<QuakeEntry> list  = parser.read(source);
        System.out.println("read data for "+list.size()+" quakes");
        //phrase “Quarry Blast” at the start of
        //String where = "start";String phrase = "Quarry Blast";
        //phrase “Alaska” at the end ,q4
        //String where="end";String phrase="Alaska";
