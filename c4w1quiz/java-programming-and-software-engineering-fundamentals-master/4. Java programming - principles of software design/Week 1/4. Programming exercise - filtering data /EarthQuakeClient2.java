...
public class EarthQuakeClient2 {
    ...
    public void quakesWithFilter() { 
        ...
        */
        ...
        //two filters
        /*
         * 1,000,000 meters (1,000 km) from Denver, Colorado 
         * whose location is (39.7392, -104.9903),
         * 
         *  end with an ‘a’ in their title 
        ...
        for (QuakeEntry qe : answer) {
            ...
            //*/
        System.out.println("q8 with two filters");
        System.out.println("Found " + answer.size() + " earthquakes ");
    }
    ...
    public void q10testMatchAllFilter() {
        String source = "data/nov20quakedata.atom";
        EarthQuakeParser parser = new EarthQuakeParser();
        ArrayList<QuakeEntry> list = parser.read(source);
    ...
    public void q11testMatchAllFilter2() {
        String source = "data/nov20quakedata.atom";
        EarthQuakeParser parser = new EarthQuakeParser();
        ArrayList<QuakeEntry> list = parser.read(source);
        System.out.println("read data for "+list.size()+" quakes");
