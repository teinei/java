...
public class QuakeSortInPlace {
    ...
    public void sortByLargestDepth(ArrayList<QuakeEntry> quakeData) {
        ...
        for (int i=0; i<limit; i++) {
            ...
            System.out.println(i+"th"+" pass");
        }
    }
    
    public void q1testSortByLargestDepth() {
        //earthQuakeDataDec6sample2.atom
    ...
    public void q3testSortByMagnitudeWithBubbleSortWithCheck() {
    ...
    public void q2testSortByMagnitudeWithCheck() {
